...
public class EditorPalette extends JPanel
{
	 ...
	 * @param value
	 */
	public mxCell addEdgeTemplate(final String name, ImageIcon icon, String style,
								  int width, int height, String cellName, String cellType, Object value) {
		...
		cell.setStyle(style);
*/      mxCell cell = new mxCell(null, value, geometry, style);
		cell.setEdge(true);
