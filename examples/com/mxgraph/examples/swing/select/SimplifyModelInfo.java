...
public class SimplifyModelInfo implements Serializable {
    ...
    public SimplifyModelInfo(String filePath,
                             Map<String, OwlClass> classMap,
                             Map<String, OwlObjectAttribute> objAttrMap,
                             Map<String, OwlDataAttribute> dataAttrMap,
                             Map<String, OwlObject> objMap,
                             Map<String, OwlObject> main_objMap,
                             Map<String, Object> vertex_objMap,
                             Map<String, OwlObject> vertex_main_objMap,
                             Map<Object, String> edge_objMap) {
