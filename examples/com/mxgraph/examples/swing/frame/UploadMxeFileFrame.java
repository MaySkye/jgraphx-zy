...
public class UploadMxeFileFrame extends JFrame {
...
//	}
     ...
     * Create the frame.
     */
    public UploadMxeFileFrame(BasicGraphEditor editor) {
        ...
        btnSubmit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                String filename = System.getProperty("java.io.tmpdir") + "/" + fileNameFiled.getText() + ".mxe";
